...
class BiomassHarvest extends Model
{
    /** @use HasFactory<\Database\Factories\BiomassHarvestFactory> */
    use HasFactory;
    protected $fillable = [
    ...
    {
        return $this->hasMany(FishReading::class, 'related_id')->where('type', 'harvest');
    }
